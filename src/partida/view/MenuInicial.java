...
public class MenuInicial extends javax.swing.JFrame {
    ...
    private void buttonConectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConectarActionPerformed
        ...
        try {
            ControladorMultiplayer partida = InputSocketCliente.conectarPartida();
            if (partida != null)
                dispose();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Verifique se o ip e a porta estão digitados corretamente e tente novamente", "Erro ao conectar na partida", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void buttonCriarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCriarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Verifique se o ip e a porta estão digitados corretamente e tente novamente", "Erro ao criar servidor", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void buttonComputadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonComputadorActionPerformed
        NovaPartidaEngine telaNovaPartida = new NovaPartidaEngine(this, true);
